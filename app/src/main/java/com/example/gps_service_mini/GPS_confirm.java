...
public class GPS_confirm extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gps_confirm);

        tvGpsEnable = (TextView)findViewById(R.id.GpsEnable);
        tvNetworkEnable = (TextView)findViewById(R.id.NetworkEnable);
        tvPassiveEnable = (TextView)findViewById(R.id.PassiveEnable);
        tvGpsLatitude = (TextView)findViewById(R.id.GpsLatitude);
        tvGpsLongitude = (TextView)findViewById(R.id.GpsLongitude);
        tvNetworkLatitude = (TextView)findViewById(R.id.NetworkLatitude);
        tvNetworkLongitude = (TextView)findViewById(R.id.NetworkLongitude);
        tvPassiveLatitude = (TextView)findViewById(R.id.PassiveLatitude);
        tvPassivekLongitude = (TextView)findViewById(R.id.PassivekLongitude);
    ...
    protected void onStart() {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            //沅뚰븳???놁쓣 寃쎌슦 理쒖큹 沅뚰븳 ?붿껌 ?먮뒗 ?ъ슜?먯뿉 ?섑븳 ?ъ슂泥??뺤씤
