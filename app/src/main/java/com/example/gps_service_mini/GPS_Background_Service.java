...
import com.example.gps_service_mini.ServiceThread;
...
public class GPS_Background_Service extends Service {
    ...
    class myServiceHandler extends Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            /*intent1 = new Intent(GPS_Background_Service.this, com.example.gps_service_final.GPS_Movement_Service.class);
            startActivity(intent1.addFlags(FLAG_ACTIVITY_NEW_TASK));*/
            CurrentPosition();
        }
